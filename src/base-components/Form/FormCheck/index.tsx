  ...
  return (
    <input
      ...
      className={twMerge([
        ...
        // Input type checkbox
        props.type == "checkbox" &&
          "shadow-sm border-slate-300 cursor-pointer rounded focus:ring-4 focus:ring-offset-0 focus:ring-[#725FFE] focus:ring-opacity-20 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-[#725FFE] dark:focus:ring-opacity-50",

        // On checked
        "[&[type='radio']]:checked:bg-[#725FFE] [&[type='radio']]:checked:border-primary [&[type='radio']]:checked:border-opacity-10",
        "[&[type='checkbox']]:checked:bg-[#725FFE] [&[type='checkbox']]:checked:border-primary [&[type='checkbox']]:checked:border-opacity-10",
